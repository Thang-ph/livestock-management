...
class RCSpacing {
  static SizedBox heightSized({required BuildContext context, double? size}) =>
      SizedBox(height: UtilsReponsive.height(size ?? 10, context));
  static SizedBox withSized({required BuildContext context, double? size}) =>
      SizedBox(width: UtilsReponsive.width(size ?? 10, context));
}
